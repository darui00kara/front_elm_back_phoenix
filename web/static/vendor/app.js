...
var _user$project$App$getUserUrl = 'http://localhost:4000/api/users/1';
var _user$project$App$emailDecoder = A2(_elm_lang$core$Json_Decode$field, 'email', _elm_lang$core$Json_Decode$string);
var _user$project$App$nameDecoder = A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string);
var _user$project$App$idDecoder = A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int);
...
var _user$project$App$sendRequest = A2(_elm_lang$http$Http$send, _user$project$App$LoadUserData, _user$project$App$getUser);
